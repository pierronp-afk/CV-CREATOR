             ...
             <div className="space-y-6 animate-in slide-in-from-right duration-300 text-left">
              ...
              <div className="mb-6 p-4 bg-blue-50 border border-blue-200 rounded-lg flex gap-3 text-left">
                ...
                <div>
                  ...
                  <p className="text-[11px] text-slate-600 leading-tight text-left">Utilisez l'import PDF pour remplir votre profil. Pour l'IA : cliquez sur l'icône, le texte est copié avec le prompt, vous n'avez plus qu'à le <strong>COLLER</strong> dans l'outil (ChatGPT/Gemini) qui s'ouvrira.</p>
                </div>
              </div>
