...
const CornerTriangle = ({ customLogo }) => (
  <div className="absolute top-0 left-0 w-[120px] h-[120px] z-20 pointer-events-none">
    ...
    {customLogo ? <div className="absolute top-[10px] left-[10px] w-[60px] h-[60px]"><img src={customLogo} className="w-full h-full object-contain brightness-0 invert" style={{ transform: 'rotate(-45deg)' }} /></div> : <div className="absolute top-[25px] left-[25px] transform -rotate-45 origin-center"><span className="text-white font-black text-xl tracking-tighter italic block drop-shadow-md">SMILE</span></div>}
  </div>
);
